...
void ancs_perform_positive_action(ble_ancs_c_t m_ancs, ble_ancs_c_evt_notif_t ancs_evt_notif)
{
    nrf_ancs_perform_notif_action(&m_ancs,
                                  ancs_evt_notif.notif_uid,
                                  ACTION_ID_POSITIVE);
}

void ancs_perform_negative_action(ble_ancs_c_t m_ancs, ble_ancs_c_evt_notif_t ancs_evt_notif)
{
    nrf_ancs_perform_notif_action(&m_ancs,
                                  ancs_evt_notif.notif_uid,
                                  ACTION_ID_NEGATIVE);
...
bool ancs_notif_has_evt_flags(ble_ancs_c_evt_notif_t * p_notif)
{
    bool ret = 0;
